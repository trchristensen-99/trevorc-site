...
Specifically, knowing how easy it is to use AI tools has lowered the activation energy it takes to make myself start working. I am borrowing this concept from chemistry, where it takes a certain amount of extra energy for the components of a reaction to move through any intermediate states and form products. Generally, I procrastinate because I am happy doing whatever I want and don't want to leave that state even if the results are worth it. Doing the work usually isn't that unpleasant and I am happier/relieved once it is over, it's just getting over the hump of the transition from non-work to work that I have a hard time doing. At least until the deadline gets uncomfortably close and last-minute panic gives me enough energy to make it over the hump and do the task at hand.

![Activation energy diagram for an exergonic reaction. The vertical axis is Gibbs free energy; the horizontal axis is time. Two curves rise from a "reactants" plateau to a peak and fall to a "products" plateau, with the uncatalyzed reaction's peak markedly higher than the catalyzed one. Arrows label "Activation energy of uncatalyzed reaction" and "Activation energy of catalyzed reaction".](../static/activation-energy.jpg)
...
[^2]: what would Claude's gym personality be like? Would the personality be like normal, or more of a coach persona? You could try out different options and see what works best.
